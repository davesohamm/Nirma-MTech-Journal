...
**Click here to read:** [February Journal](https://github.com/davesohamm/Nirma-MTech-Journal/blob/main/February/README.md)

---

## **Day 169 — 2 March 2026 (Monday)**
...
- Lecture by **NKP Sir**.  
- Covered **LIME (Local Interpretable Model-agnostic Explanations)** in detail.  
- Topics discussed:
  - LIME mathematical formula  
  - Proximity concept  
  - Global vs Local functions  
  - Rules and theoretical understanding behind LIME explanations.

---

**8:40 AM – 9:35 AM | Free Lecture**  
- No scheduled academic activity.

---

**9:35 AM – 10:40 AM | MLOps (Skipped)**  
- Skipped due to **Pre-Placement Talk at 10:00 AM** and **Interview at 11:00 AM**.

---

**10:40 AM – 11:40 AM | Deep Learning (Skipped)**  
- Lecture by **Dr. Swati Jain Ma’am**.  
- Could not attend due to interview process.
...
- Discussed the interview experience with friends.  
- Received a message from guide ma’am regarding evaluation.  
- Did not go for evaluation today — pending work needs to be completed first before showing progress.
...
- Downloaded the **ASDID dataset**.  
- Spent time waiting for interview results (no mail received yet).  
