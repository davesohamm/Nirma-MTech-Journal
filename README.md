...
**Click here to read:** [November Journal](https://github.com/davesohamm/Nirma-MTech-Journal/blob/main/November/README.md)

---

## **Day 94 — 1 December 2025** (Monday)

### **11:40 AM – 12:35 PM | Big Data Systems (JV Sir)**
- Sir conducted the **final evaluation of the term paper**.
- We were instructed to **submit the editable Overleaf LaTeX link** for final review.
- Dr. Priyank Thakkar sir came and briefed us about the Internship/Placements process. (III Cell, Nirma University)
- He made one Placement WhatsApp group for our batch.
- From mid January, the season will kick start. I have to gear up fast. 🛡️🏹

---

### **12:35 PM – 1:30 PM | Applied Machine Learning (NKP Sir)**
- I **skipped this lecture**.
- Used the time to **prepare for the Big Data Systems LPW exams**.
...
### **2:25 PM – 4:15 PM | Big Data Systems LPW Exams (JV Sir)**
- The exam focused on **MongoDB operations and query solving**.
- I managed to **solve 7 out of 10 MongoDB queries**, which felt quite good.
- Here is the question paper with solution : https://chatgpt.com/c/692dcfa3-b40c-8324-aab6-c2af4b39a4c0
